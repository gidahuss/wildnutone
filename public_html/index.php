...
<?php include('include/header.php') ?>
	 ...
	 <!--Body Content Started-->
		<main class="main-body">
			<section style="background-image: url('images/banner2.jpg');" class="default-section banner-section">
				<div class="container">
      ...
      <section class="default-section our-products-section section-top-border pt-0 pb-5" id="our-products">
				<div class="container">
          <div class="logo-w text-center mb-3"><img alt="" src="images/logo-w.png" width="86" height="103"></div>
          <h2 class="title-section mb-4 pb-2 text-center">Products</h1>
      ...
      <section class="default-section gallery-section section-top-border pt-0 pb-5" id="gallery" style='padding:50px'>
          ...
          <script type="text/javascript" src="https://www.juicer.io/embed/wildwildnut/embed-code.js?per=9&truncate=30" async defer></script>
          <!-- Swiper -->
